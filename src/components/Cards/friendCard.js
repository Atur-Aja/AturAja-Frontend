  ...
  return (
    <div className="bg-white shadow-lg rounded-xl p-4 mt-4 cursos-pointer flex justify-between">
      <div className="grid grid-cols-3 gap-4"> 
        <div className="bg-gray-300 border-2 border-gray-200 shadow-xl w-16 h-16 sm:w-20 sm:h-20 rounded-full justify-self-center flex flex-wrap content-center justify-center ">
          <img className="inline object-cover w-16 h-16 sm:w-20 sm:h-20 items-center justify-center place-self-center rounded-full " src={photo} alt="Profile" />
        </div>
        <div className="col-span-2 text-center self-center text-md text-abuTua justify-between ">
          ...
          <p>{email}</p>
          <p>{phoneNumber}</p>
          <button className="w-full items-center justify-center place-self-center bg-red-600 hover:bg-red-800 shadow-xl text-white rounded-lg px-3 py-1 mx-1 mt-2" onClick={handleDelete}>
            Remove Friend
          </button>
        </div>
      </div>
