...
export default function LandingPage() {
  ...
  return (
    <div className="bg-abuMuda flex flex-col md:flex-row items-center justify-center my-8 md:my-12 2xl:my-20 md:my-10 md:mx-4 lg:mx-6 xl:mx-8 2xl:mx-20">
      <div className="w-full md:w-1/2 flex flex-wrap items-center justify-center">
        <div className="flex flex-wrap content-center text-abuTua md:self-center text-center">
          <p className="text-base md:text-lg lg:text-xl xl:text-3xl 2xl:text-4xl mx-4 2xl:mx-10">Create a collaboration schedule without struggle</p>
        ...
        <Link to="/">
          <button className="bg-biruTua hover:bg-biru text-white font-semibold my-2 mb-10 px-6 md:px-8 py-2 rounded-full shadow-2xl">
            Download for Mobile
          </button>
        </Link>
      </div>
          ...
          <form>
              {isRegister ? (
                 <><div className="mt-1 lg:mt-6">
                    ...
                    <div className="grid mt-4 md:mt-6 lg:mt-16">
                      ...
                      <div className="flex place-self-center mt-2">
                        ...
                        <p onClick={() => setIsRegister()} className="text-biru text-xs md:text-sm lg:text-base xl:text-lg hover:text-biruTua">Sign in</p>
                      </div>
                    </div>
                  </div>
                 </div></>
                ...
                <div className="mt-5 mx-2">
                  ...
                  <><><AuthField placeholder={"Email / username"} value={email} onChange={(email) => setEmail(email)} icon={<Email />} /><AuthField
                    placeholder={"Password"}
                    value={password}
                    onChange={(pass) => setPassword(pass)}
                    icon={isReveal ? <EyeOff /> : <Eye />}
                    ...
                    onKeyPress={handleKeyPress} /></>
                      <div className="mt-2 flex justify-end text-gray-600 text-xs md:text-sm lg:text-base xl:text-lg hover:text-biru">
                      ...
                      </div><div className="grid mt-12 md:mt-20 lg:mt-24">
                        ...
                        <div className="flex place-self-center mt-2">
                          ...
                          <p onClick={() => setIsRegister(!isRegister)} className="text-biru text-xs md:text-sm lg:text-base xl:text-lg hover:text-biruTua">Sign Up</p>
                        </div>
                      </div></></>
                </div>
              )}
